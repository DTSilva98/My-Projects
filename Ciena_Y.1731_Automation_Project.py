#Created by Daniel Silva on 10/22/2024

#This program connects to a specific Ciena device and automates the creation of Y.1731 tests for new circuits.
#It supports version 6 and 10 devices and could be extended to support version 8 or other devices such as Accedian.

#This automation process aims to reduce human error and save time, allowing employees to spend less time
#building tests for new circuits on devices running various versions.

#Note:
#- This code was created halfway through my first programming class, so it could be improved.
#- Some values are generic to protect company information.
#- The project could be scaled to support other devices like Accedian, etc.

#To run this program, Python and the Netmiko library must be installed.
import sys
